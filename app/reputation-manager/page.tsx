...
const description =
  "Automated review requests after every job, intelligent routing for unhappy customers, and a dashboard that shows what's actually moving your Google rating. Setup in 7 to 14 days.";
