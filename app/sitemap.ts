...
const routes: { path: string; priority: number; changeFrequency: Freq; lastModified?: string }[] = [
  ...
  { path: "/locations/chicago", priority: 0.8, changeFrequency: "monthly", lastModified: "2026-05-15" },
  { path: "/locations/macomb", priority: 0.8, changeFrequency: "monthly", lastModified: "2026-05-13" },
  { path: "/industries/auto-dealerships", priority: 0.8, changeFrequency: "monthly", lastModified: "2026-05-15" },
