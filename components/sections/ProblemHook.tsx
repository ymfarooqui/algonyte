    ...
    <section className="section">
      ...
      >
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          <motion.div variants={reveal.fadeUpLg} className="reveal-static gpu-stable">
            <CountUp
              to={67}
              suffix="%"
              durationMs={1800}
        ...
        <motion.div className="reveal-static gpu-stable mt-16 max-w-4xl mx-auto" variants={reveal.fadeUpLg}>
          <PhoneConversation />
        </motion.div>
      </motion.div>
    </section>
